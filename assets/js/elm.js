	...
	return A2(
		...
		_List_fromArray(
			[
				...
				A2($elm$html$Html$Attributes$style, 'height', radius),
				A2($elm$html$Html$Attributes$style, 'width', radius),
...
var $author$project$Main$viewBalls = function (balls) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		A2($elm$core$List$map, $author$project$Main$viewBall, balls));
};
var $author$project$Main$AddBall = {$: 'AddBall'};
var $author$project$Main$viewControls = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$Events$onClick($author$project$Main$AddBall)
				]),
			_List_fromArray(
				[
					$elm$html$Html$text('Add Ball')
				]))
		]));
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				A2($elm$html$Html$Attributes$style, 'background', '#3C4C60'),
				...
				case 'StartedButNoData':
					return _List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Events$onClick($author$project$Main$SendMessageToOutsideElm)
								]),
							_List_fromArray(
								[
